...
plot(women, type='l')
plot(women, type='b')
plot(women, type='b', pch=19, lty=1, col=1)
plot(women, xlim=c(30,100), ylim=c(min(women$weight) 200), pch=18)

#more features with plot
plot(x=women$weight, y=women$height, pch=15, xlab='Weight', ylab='Height', col='red', cex=1, type='b')
title(main='Main Title', sub='Sub Title')
#see cheat sheet on base graphs

plot(women)
abline(lm(women$weight ~ women$height), col='red', lty=2, lwd=3)
